...
import asyncio
from components.cruds.controllers.controllerProductsStock import router  # Cambia el nombre del controlador
import reactpy
from api import getProductsStock, postProductStock, deleteProductStock  # Cambia los nombres de las funciones
