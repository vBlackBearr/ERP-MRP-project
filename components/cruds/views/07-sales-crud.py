...
import asyncio
from components.cruds.controllers.controllerSales import router  # Cambia el import al controlador de ventas
import reactpy
from api import getSales, postSale, deleteSale  # Cambia los nombres de las funciones de API
